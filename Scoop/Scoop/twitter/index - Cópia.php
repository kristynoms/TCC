...
*/
echo twitter_generate_search_form('index.php',false,false,true,true,$_GET);
?>
...
Below function shows user timeline results for the screen name entered into the function
...
<?php
/**
show the twitter search results
first variable is the query
second variable is the language code
third variable is the result_type
