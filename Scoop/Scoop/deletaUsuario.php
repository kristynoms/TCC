...
<?php
          ...
          echo" <div class='col-lg-62'>
           <div class='well2'>
           <form action=\"deleteUser.php\" method=\"post\" class='bs-example form-horizontal' name='DelUser'>
    ...
    <div class='col-lg-10 col-lg-offset-2'>
        <button class='btn btn-default' onclick=\"location.href='ListaDelUsuario.php'\">Cancel</button>
        <button class='btn btn-primary' onclick='msg()' >Confirmar</button>
